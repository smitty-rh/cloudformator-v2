...
echo
echo "Execute: bin/rails r "User.find_by(userid: 'admin').update_attributes(:password => 'smartvm')""
date;read -t $pause_in_seconds -p "Press any key or wait $pause_in_seconds seconds";echo;date
bin/rails r "User.find_by(userid: 'admin').update_attributes(:password => 'smartvm')"
